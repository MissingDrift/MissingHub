package me.missigdrift.missinghub.license;
...
public class License {
	...
	public boolean register(){
		log(0, "[MissingHub] Connecting to License-Server...");
		ValidationType vt = isValid();
		if(vt == ValidationType.VALID){
			log(1, "[MissingHub] License valid!");
			return true;
		}else{
			log(1, "[MissingHub] License is NOT valid!");
			log(1, "[MissingHub] Failed as a result of "+vt.toString());
